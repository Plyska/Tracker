 ...
 * фавікона (favicon.ts), статичного `public/favicon.svg` (той — копія виводу, при зміні
 * перегенерувати) і растрів у `public/favicon.ico` (`npm run gen:favicon`). Усе в полі 32×32.
 */
